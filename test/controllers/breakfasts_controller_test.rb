...
class BreakfastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create breakfast" do
    assert_difference("Breakfast.count") do
      post breakfasts_url, params: { breakfast: { item_description: @breakfast.item_description, item_name: @breakfast.item_name, item_price: @breakfast.item_price } }
    end
  ...
  test "should update breakfast" do
    patch breakfast_url(@breakfast), params: { breakfast: { item_description: @breakfast.item_description, item_name: @breakfast.item_name, item_price: @breakfast.item_price } }
