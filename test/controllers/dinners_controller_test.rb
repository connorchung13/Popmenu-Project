...
class DinnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dinner" do
    assert_difference("Dinner.count") do
      post dinners_url, params: { dinner: { item_description: @dinner.item_description, item_name: @dinner.item_name, item_price: @dinner.item_price } }
    end
  ...
  test "should update dinner" do
    patch dinner_url(@dinner), params: { dinner: { item_description: @dinner.item_description, item_name: @dinner.item_name, item_price: @dinner.item_price } }
