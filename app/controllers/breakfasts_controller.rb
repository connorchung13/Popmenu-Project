class BreakfastsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @breakfast.save
        format.html { redirect_to breakfast_url(@breakfast), notice: "Breakfast was successfully created." }
  ...
  def update
    respond_to do |format|
      if @breakfast.update(breakfast_params)
        format.html { redirect_to breakfast_url(@breakfast), notice: "Breakfast was successfully updated." }
  ...
  private
    ...
    def breakfast_params
      params.require(:breakfast).permit(:item_name, :item_description, :item_price)
    end
end
